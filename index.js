...
exports.RADIANS_MULT = exports.InMemoryCache = exports.DEGREES_MULT = exports.BinarySearch = void 0;
exports.assert = assert;
exports.attempt = attempt;
exports.coerceHash = coerceHash;
exports.expectType = exports.exec = exports.equal = exports.effect = exports.constant = void 0;
exports.fastHash = fastHash;
exports.findItemsFrom = findItemsFrom;
exports.groupBy = groupBy;
exports.hashWithLength = hashWithLength;
exports.isInDebug = exports.importSync = exports.iife = exports.identity = void 0;
...
exports.noop = void 0;
exports.ok = ok;
exports.parseArgs = exports.once = exports.okOr = void 0;
exports.pipe = pipe;
...
// node_modules/argparse/lib/textwra
...
// node_modules/argparse/lib/textwrap.jsoupByIterator.j
...
// node_modules/argparse/lib/textwrap.jsou
...
// node_modules/argparse/lib/textwrap.jsoupByIterator.jso
...
// node_modules/argparse/lib/textwrap.jsoupByIterato
class MapIterator {
...
// node_modules/argparse/lib/textwrap.jso
...
function sortByKeys(obj, comparator = (a, b) => a.localeCompare(b)) {
  return Object.keys(obj).sort(comparator).reduce((acc, key) => {
    const value = obj[key];
    if (!Array.isArray(value) && isObjectLike(value)) acc[key] = sortByKeys(value, comparator);else acc[key] = value;
    return acc;
  }, {});
}
...
exports.main = main;
var sh = (...commands) => iife(({
  spawn
} = importSync("child_process")) => {
  const fullCommand = commands.join("\n");
  return new Promise(resolve => {
    const s = attempt(() => spawn(fullCommand, {
      shell: true,
      stdio: "inherit"
    }));
...
exports.exec = exec;
var isInDebug = () => typeof __require("inspector").url() !== "undefined";
